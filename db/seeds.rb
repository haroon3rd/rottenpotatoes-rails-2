...
movies = [{:title => 'Aladdin', :rating => 'G', :release_date => '25-Nov-1992', :director => 'Ron Clements'},
    	  ...
    	  {:title => 'When Harry Met Sally', :rating => 'R', :release_date => '21-Jul-1989', :director => 'Rob Reiner'},
      	  ...
      	  {:title => 'The Incredibles', :rating => 'PG', :director => 'Brad Bird'},
      	  {:title => 'The Incredibles II', :rating => 'PG', :director => 'Brad Bird'},
      	  {:title => 'Avatar', :rating => 'PG', :director => 'James Cameron'},
      	  {:title => 'Movie with no director info', :rating => 'PG-13'},
